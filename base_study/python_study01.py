...
# 已双下划线开头和结尾的(__x__)，通常是系统成员，应避免使用
# 在交互模式下，单下划线(_)返回，最后一个表达式结果

# 弱引用可用于一些特定场合，比如缓存监控等
...
x1 = X()
# x1 = {"data": 1, "name": "jiangzhw"}
x1.data = [1, 2, 3]
x2 = copy.copy(x1)
x3 = copy.deepcopy(x1)
print(x2.data is x1.data)
print(x3.data is x1.data)
